...
/*
	...
	La classe `Goblin` aura cependant acces aux variables et fonctions `public` et `protected` de `Character`,
	mais pas a tout ce qui est `private`.
	...
	ou une autre classe derivee `Avion`, qui sont aussi des vehicules mais
